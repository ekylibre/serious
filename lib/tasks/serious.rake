...
namespace :serious do
  ...
  task :game => :environment do
    ...
    15.times do |index|
      ...
      farms[code] = {name: "Ferme #{FFaker::NameFR.last_name}#{index}", historic: "SL47", stand_number: "S" + code}
      4.times do
    ...
    ["Crédit Agricole", "Groupama", "Unicoque", "Terre du Sud", "Razol", "CER", "@com", "MSA"].each_with_index do |name, index|
      ...
      items = VARIANTS.sample(15).map do |v|
        {variant: v, quota: 7}
      end
